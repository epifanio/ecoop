...
cd gdal-1.10.1
CPPFLAGS=-I$PREFIX/include ./configure --with-hdf5=$PREFIX/ --with-pg=$PREFIX/bin/pg_config --with-geos=$PREFIX/bin/geos-config --with-spatialite=$PREFIX/ --with-freexl=$PREFIX/ --with-python=$PREFIX/bin/python --prefix=$PREFIX/ --with-netcf=$PREFIX/ >> ../gdal_configure.log
